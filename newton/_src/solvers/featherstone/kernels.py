...
def jcalc_tau(
    ...
    if type == newton.JointType.PRISMATIC or type == newton.JointType.REVOLUTE or type == newton.JointType.D6:
...
def jcalc_integrate(
    ...
    # prismatic / revolute
    if type == newton.JointType.PRISMATIC or type == newton.JointType.REVOLUTE:
