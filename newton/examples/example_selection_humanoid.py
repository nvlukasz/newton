...
class Example:
    def __init__(self, stage_path=None, num_envs=8):
        ...
        builder, stage_info, env_offsets = replicate_environment(
            newton.examples.get_asset("humanoid_prototype.usd"),
            "/World/envs/env_0",
            "/World/envs/env_{}",
            num_envs,
            (5.0, 5.0, 0.0),
        ...
        # print(f"joint_q shape:      {self.humanoids.get_attribute_shape('joint_q')}")
        # print(f"joint_qd shape:     {self.humanoids.get_attribute_shape('joint_qd')}")
        # print(f"joint_f shape:      {self.humanoids.get_attribute_shape('joint_f')}")
        # print(f"joint_target shape: {self.humanoids.get_attribute_shape('joint_target')}")
        # print(f"body_q shape:       {self.humanoids.get_attribute_shape('body_q')}")
        # print(f"body_qd shape:      {self.humanoids.get_attribute_shape('body_qd')}")

        # set all dofs to the middle of their range by default
        # dof_limit_lower = wp.to_torch(self.humanoids.get_attribute("joint_limit_lower", self.model))
